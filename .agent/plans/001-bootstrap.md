...
- [ ] (2026-02-07) Milestone 1: Repository creation, tooling setup, and first deploy (remaining: git init, GitHub repo create, Vercel link + env vars, first production deploy).
